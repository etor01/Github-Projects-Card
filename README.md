...
3. **Include the Script**: Link the `app.js` file at the bottom of your `<body>` tag.
4. **Change the Username**: Open `app.js` and update the `GITHUB_USERNAME` variable to your own:
   ```javascript
...
You can tweak the Javascript parameters in `app.js` to change what data shows up:
